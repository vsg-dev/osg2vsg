...
namespace vsg
{
    ...
    public:
        ...
        vsg::ImageData createSharedMemoryImageData(Context& context, Sampler* sampler, VkImageLayout targetImageLayout)
        {
            ...
            externalImageFormatProperties = *(VkExternalImageFormatProperties*)imageFormatProperties2.pNext;
            ...
            auto vkGetMemoryWin32HandleKHR = PFN_vkGetMemoryWin32HandleKHR(vkGetDeviceProcAddr(device->getDevice(), "vkGetMemoryWin32HandleKHR"));
            vkGetMemoryWin32HandleKHR(device->getDevice(), &getHandleInfo, &_memoryHandle);
...
int main(int /*argc*/, char** /*argv*/)
{
    ...
    osgviewer->realize();
    osgviewer->getCamera()->getGraphicsContext()->makeCurrent();
    ...
    osgviewer->getCamera()->getGraphicsContext()->releaseContext();
